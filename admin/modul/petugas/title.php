        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <form action="logout.php" method="post">
              <button class="dropdown-item" type="submit" name="keluar" onclick="return confirm('yakin ingin logout?');">
                  ...
                  <div class="modal-body">
                    <form action="?m=petugas&s=simpan" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <small class="form-text text-muted">Masukkan Nama Petugas</small>
                      </div>
                      <div class="form-group">
                        <label for="telepon">Telepon Petugas</label>
                        <input type="text" class="form-control" id="telepon" name="telepon"
                          placeholder="Masukkan Telepon Petugas" required>
                        <small class="form-text text-muted">Masukkan Telepon Petugas</small>
                      </div>
                  </div>
                  ...
                  <tbody>
                    ...
                    while ($data = mysqli_fetch_array($query)) {
                      echo "<tr>
                                            ...
                                            <td>{$data['telepon']}</td>
                                            <td>
                                                <a href='?m=petugas&s=ubah&id_petugas={$data['id_petugas']}' class='btn btn-warning btn-sm'>Edit</a>
                                                <a href='?m=petugas&s=hapus&id_petugas={$data['id_petugas']}' class='btn btn-danger btn-sm' onclick='return confirm(\"Yakin ingin menghapus?\")'>Delete</a>
                                            </td>
                                        </tr>";
                    }
                    ?>
